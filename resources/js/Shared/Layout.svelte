          ...
          <div class="header-button">
              ...
              <div class="noti__item js-item-menu">
                ...
                <div class="mess-dropdown js-dropdown">
                  ...
                  <div class="mess__footer">
                    <a href=".`" on:click|preventDefault>View all messages</a>
                  </div>
                </div>
              </div>
              <div class="noti__item js-item-menu">
                ...
                <div class="email-dropdown js-dropdown">
                  ...
                  <div class="email__footer">
                    <a href=".`" on:click|preventDefault>See all emails</a>
                  </div>
                </div>
              </div>
              <div class="noti__item js-item-menu">
                ...
                <div class="notifi-dropdown js-dropdown">
                  ...
                  <div class="notifi__footer">
                    <a href=".`" on:click|preventDefault>All notifications</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="account-wrap">
              <div class="account-item clearfix js-item-menu">
                ...
                <div class="content">
                  <a class="js-acc-btn" href=".`" on:click|preventDefault>
                    john doe
                  </a>
                </div>
                <div class="account-dropdown js-dropdown">
                  <div class="info clearfix">
                    ...
                    <div class="content">
                      <h5 class="name">
                        <a href=".`" on:click|preventDefault>john doe</a>
                      </h5>
